...
import ind.learningSpring.utils.TokenUtilImpl;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public AuthenticationFilter(UserDetailServiceImpl userDetailsService, TokenUtilImpl tokenUtil) {
...
//
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (tokenUtil.validateToken( userDetails, jwtToken)) {
