...
//        return person.orElseThrow(() -> new IllegalArgumentException());
        ...
        return new Resource<>( person.orElseThrow(()-> new PersonNotFoundException(id)) , linkTo( methodOn(FirstController.class).getAll()).withRel("all") , linkTo( methodOn( FirstController.class).getOne(id)).withSelfRel() );//roye obj gharar migirad va linke haro mitonam besh ezafe konam
